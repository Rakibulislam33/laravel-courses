            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    <div class="flex items-center gap-3 mt-5">
                        ...
                        <a href="#reviews" class="text-sm text-gray-500"> {{ count($course->reviews) }}
                            Review{{ count($course->reviews) > 1 ? 's' : ''}} </a>
                    </div>
                    <ul class="flex flex-wrap items-center gap-4 mt-5 text-gray-700">
                        <li class="flex items-center gap-2">
                            <svg class="w-6 h-6 text-gray-400 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <li class="flex items-center gap-2">
                            <svg class="w-6 h-6 text-gray-400 shrink-0" xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <div class="mb-6 bg-white p-4">
                        ...
                        <h4 class="font-bold">{{$review->user->name ?? 'none'}}</h4>
                    </div>
                    @endforeach
                ...
                <div class="w-1/3 pl-10 pt-0">
                    <div class="mt-2 mb-4 space-y-3">
                        <a href="{{ $course->link }}" target="_blank"
                            ...
                            Get the {{ $course->type ? 'Book' : 'Course' }} <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="mt-2 mb-7 space-y-3">
                        <a href="#"
                            ...
                            Write a Review &nbsp; <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="space-y-4 pb-2">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover w-48 m-auto shadow" src="{{ $author->image }}"
                                        alt="{{ $author->name }}">
                                </div>
                                ...
                                <ul role="list" class="flex space-x-5 justify-center">
                                    ...
                                    <li>
                                        <a href="{{ $author->twitter_url }}" class="text-gray-400 hover:text-gray-500"
                                            target="_blank">
                                    ...
                                    <li>
                                        <a href="{{ $author->github_url }}" class="text-gray-400 hover:text-gray-500"
                                            target="_blank">
                                    ...
                                    <li>
                                        <a href="{{ $author->website_url }}" class="text-gray-400 hover:text-gray-500"
                                            target="_blank">

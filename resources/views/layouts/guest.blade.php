      ...
      <footer class="w-full bg-dark pt-[94px] relative">
        ...
        <div class="container flex justify-between pb-[50px]">
          ...
          <div>
            ...
            <ul class="mt-5">
              <li class="mb-2">
                <a href="{{ route('archive',['duration','1-5']) }}" class="text-links text-gray-100 text-base before:text-gray-100">1-5 hours</a>
              </li>
              <li class="mb-2">
                <a href="{{ route('archive',['duration','5-10']) }}" class="text-links text-gray-100 text-base before:text-gray-100">5-10 hours</a>
              </li>
              <li class="mb-2">
                <a href="{{ route('archive',['duration','10+']) }}" class="text-links text-gray-100 text-base before:text-gray-100">10+ hours</a>
              </li>
            </ul>
          </div>
          <div>
